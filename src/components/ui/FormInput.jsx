export const FormInput = ({ id, label, type = 'text', placeholder, required = false }) => {
    const inputBaseStyle = "w-full bg-white border-2 border-gray-border rounded px-4 py-3 font-body text-text-primary transition-all duration-300 focus:outline-none focus:border-accent-500 focus:ring-4 focus:ring-accent-500/10";
